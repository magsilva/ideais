...
public class VtigerUtil
{
	 ...
	 * @return
	 */
	final public static String createPstmtInsert(VtigerObject obj)
	{
	 ...
	 * @return
	 */
	final public static String createPstmtUpdate(VtigerObject obj)
	{
	 ...
	 */
	final public static String createPstmtDeleteId(Class<? extends VtigerObject> clazz)
	{
		StringBuffer sb = new StringBuffer();
		String table = null;
		String idField = null;
	...
	*/
	 ...
	 * @return The SQL prepared statement to read an object of the given class.
	 */
	final public static String createPstmtSelectId(Class<? extends VtigerObject> clazz)
	{
		StringBuffer sb = new StringBuffer();
		String table = null;
		String idField = null;
