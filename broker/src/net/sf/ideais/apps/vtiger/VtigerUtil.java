...
public class VtigerUtil
{
	 ...
	 */
	final public static String createPstmtInsert(Class<? extends VtigerObject> clazz)
	{
	 ...
	 */
	final public static PreparedStatement createPstmtInsert(Connection conn, VtigerObject obj)
	{
		Class<? extends VtigerObject> clazz = obj.getClass();
		StringBuffer sb = new StringBuffer();
		String table = null;
		Field[] beanFields = null;
		String[] dbFields = null;
	 ...
	 * @return
	 */
	final public static String createPstmtUpdate(Class<? extends VtigerObject> clazz)
	{
		StringBuffer sb = new StringBuffer();
		String table = null;
		Field[] beanFields = null;
	 ...
	 * Compile the prepared statement for inserting a project into the database.
	 */
	final public static PreparedStatement createPstmtUpdate(Connection conn, VtigerObject obj)
	{
		Class<? extends VtigerObject> clazz = obj.getClass();
		StringBuffer sb = new StringBuffer();
		String table = null;
	 ...
	 */
	final public static String createPstmtDeleteById(Class<? extends VtigerObject> clazz)
	{
		StringBuffer sb = new StringBuffer();
		String table = null;
		String idField = null;
	 ...
	 * @return The SQL prepared statement to read an object of the given class.
	 */
	final public static PreparedStatement createPstmtDeleteById(Connection conn, VtigerObject obj)
	{
		Class<? extends VtigerObject> clazz = obj.getClass();
		StringBuffer sb = new StringBuffer();
		String table = null;
	 ...
	 * @return The SQL prepared statement to read an object of the given class.
	 */
	final public static String createPstmtDeleteByExample(Class<? extends VtigerObject> clazz)
	{
		StringBuffer sb = new StringBuffer();
		String table = null;
		Field[] beanFields = null;
	 ...
	 * @return The SQL prepared statement to read an object of the given class.
	 */
	final public static PreparedStatement createPstmtDeleteByExample(Connection conn, VtigerObject obj)
	{
		Class<? extends VtigerObject> clazz = obj.getClass();
		StringBuffer sb = new StringBuffer();
		String table = null;
	 ...
	 * @return The SQL prepared statement to read an object of the given class.
	 */
	final public static String createPstmtSelectById(Class<? extends VtigerObject> clazz)
	{
		StringBuffer sb = new StringBuffer();
		String table = null;
		String idField = null;
	 ...
	 * @return The SQL prepared statement to read an object of the given class.
	 */
	final public static PreparedStatement createPstmtSelectById(Connection conn, Class<? extends VtigerObject> clazz,
			Object id)
	{
		StringBuffer sb = new StringBuffer();
		String table = null;
		...
		parentTable = AnnotationUtil.getAnnotationValue(clazz.getSuperclass(), DbAnnotations.TABLE_ANNOTATION);
		fields = AnnotationUtil.getAnnotatedFields(clazz, DbAnnotations.IDENTIFICATOR_ANNOTATION);
		for (Field f : fields) {
			idField = table + "." + AnnotationUtil.getAnnotationValue(f, DbAnnotations.PROPERTY_ANNOTATION);
		}
		fields = AnnotationUtil.getAnnotatedFields(clazz.getSuperclass(), DbAnnotations.IDENTIFICATOR_ANNOTATION);
		for (Field f : fields) {
			parentIdField = parentTable + "." + AnnotationUtil.getAnnotationValue(f, DbAnnotations.PROPERTY_ANNOTATION);
		}
		sb.append(" INNER JOIN ");
		sb.append(parentTable);
		sb.append(" ON ");
		sb.append(parentIdField);
		sb.append("=");
		sb.append(idField);
	...
	final public static String createPstmtSelectByExample(Class<? extends VtigerObject> dpobject)
	{
		StringBuffer sb = new StringBuffer();
		String table = null;
		String idField = null;
	...
	final public static PreparedStatement createPstmtSelectByExample(Connection conn, VtigerObject obj)
	{
		Class<? extends VtigerObject> clazz = obj.getClass();
		StringBuffer sb = new StringBuffer();
		String table = null;
