...
/**
 * Configuration to access a Subversion repository.
 * 
 * It's a decorator for SVNAdmin, a administration related Subversion class.
 ...
 * internal state that interfere with the methos execution). Theorycally, it
 * could be safelly shared by all SubversionRepository instances, but JNI is
 * strange and sharing it causes some exceptions.
 *  
...
public class SubversionRepository extends AbstractRepository
{
	...
	*/
     ...
     * to a file.
     * 
     * This class was extracted from SVNTests.java (Subversion 1.1.4).
	...
	/**
	 * If the location is of the type "file", return the real physical location
	 * of the repository in the server. Otherwise, return null;
	...
	/**
	 * Initialize a repository (if possible). The backend used is the fsfs (it has less
	 * dependencies than bdb and it's easier to admin - aka doesn't require recover).
	 * 
	 * @throws RepositoryError If the location is not an URL with the "file" protocol or
	 * an error occurs while creating the repository.
	 */
	public void init()
	{
	 ...
	 * 
	 * @throws RepositoryError If the location is not an URL with the "file" protocol or
	 * an error occurs while dumping the repository.
	 */
	public File dump()
	{
	 ...
	 * 
	 * @throws RepositoryError If the location is not an URL with the "file" protocol or
	 * an error occurs while loading the dump.
	 */
