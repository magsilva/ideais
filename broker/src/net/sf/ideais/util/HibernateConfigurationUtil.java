...
/**
 * The DataSource is used to change the data source configuration used by Wiki/RE.
 * 
...
public final class HibernateConfigurationUtil
{
	...
	*/
	 ...
	 * 
	 * @param namingContext Start point context.
	 * 
	...
	/**
	 * Get a listing of JDBC drivers supported by Wiki/RE. This listing is provided as a
	 * mapping (String, String), more precisely (Java class name, Description).
	 * 
	 * @return A mapping of JDBC drivers.
	 */
	public static Map getSupportedJDBC()
	{
	 ...
	 */
	public static Map getHibernateDialects()
	{
