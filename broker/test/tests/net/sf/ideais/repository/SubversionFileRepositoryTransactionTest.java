 ...
 */
public class SubversionFileRepositoryTransactionTest extends AbstractRepositoryTransactionTest
{
	/**
	...
	protected RepositoryTransaction getRepositoryTransaction()
	{
		...
		repository.setLocation(SubversionRepositoryConstants.FILE_REPOSITORY);
